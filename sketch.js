...
function setup() {
  ...
  //Creating THIRD ROW
  box10=new Box(500,260,40,40);
  box11=new Box2(545,260,40,40);
  box12=new Box(585,260,40,40);
  //Creating SECOND ROW
  box13=new Box2(520,200,40,40);
  box14=new Box(560,200,40,40);
  //Creating TOP ROW
  box15=new Box(540,150,40,40);
